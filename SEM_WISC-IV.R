...
wisc4.model3<-'
 ...
 # define structural relations
  Verbal ~ k*Fluid'
wisc4.fit3 <- lavaan::cfa(model=wisc4.model3, 
                          sample.cov=wisc4.cov, 
                          sample.nobs=550,
                          std.lv=TRUE)
lavaan::varTable(wisc4.fit3)
lavaan::summary(wisc4.fit3, fit.measures=TRUE, standardized=TRUE, rsq=TRUE)
semPlot::semPaths(wisc4.fit3,
                  layout="tree",
                  style="lisrel",
                  what="path",
                  residuals=TRUE,
